...
Contributors: Azeez
Tags: debug, log, error log, developer tools
...
== Installation ==
1. Upload the plugin files to the `/wp-content/plugins/debug-log` directory, or install the plugin through the WordPress plugins screen directly.
2. Activate the plugin through the 'Plugins' screen in WordPress.
3. Navigate to "Debug Log" under the "Tools" menu in the WordPress admin dashboard to view or manage your debug log.
